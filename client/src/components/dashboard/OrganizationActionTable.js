  ...
  render() {
    ...
    return (
      <React.Fragment>
                      ...
                      <TableCell align="left" onClick={() => {
                        ...
                        <TableCell align="left" onClick={() => {
                          ...
                          >
                             ...
                             <TableCell align="left" onClick={() => {
                            this.setEditRedirect(OrganizationAction.id);
                          }} className={classes.noTextDecoration}><Typography className={classes.heading}>{OrganizationAction.status}</Typography>
                            </TableCell>
        ...
        />
 <Fab component={Link} color="primary" aria-label="Add" to={{ pathname: "/OrganizationAction", state: { orgId: this.props.orgId } }} className={classes.fab}>
            <AddIcon />
          </Fab>
        <Snackbar
